...
WHR_AS_comparison_2013$WHR_rank_2013 <- rank(-WHR_AS_comparison_2013$Ladder)
WHR_AS_comparison_2013$AS_rank_2013 <- rank(-WHR_AS_comparison_2013$AS_score)

comparison_2013_2023 <- merge(WHR_AS_comparison, WHR_AS_comparison_2013, by.x="COUNTRY_ISO3", by.y="COUNTRY_ISO3")

notable_countries_score <- comparison_2013_2023 %>% 
...
notable_countries_rank <- comparison_2013_2023 %>% 
  filter(WHR_rank > WHR_rank_2013 & AS_rank < AS_rank_2013 |
         WHR_rank < WHR_rank_2013 & AS_rank > AS_rank_2013) %>% 
  dplyr::select(COUNTRY_ISO3 = COUNTRY_ISO3, Country = region, WHR_2023 = WHR_rank, AS_2023 = AS_rank, WHR_2013 = WHR_rank_2013, AS_2013 = AS_rank_2013) %>% 
  mutate(WHR_diff = WHR_2023 - WHR_2013,
         AS_diff = AS_2023 - AS_2013,
         diff_of_diff = WHR_diff - AS_diff) %>% 
  filter(COUNTRY_ISO3 != "CYP")
