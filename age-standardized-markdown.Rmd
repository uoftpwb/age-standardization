...
laos$LAO[is.na(laos$LAO)] <- 0

# Convert the Year column to numeric
laos$Year <- as.numeric(laos$Year)

# Create a new column for the year group (2010-2012 and 2020-2022)
laos <- laos %>%
  mutate(Year_Group = case_when(
    between(Year, 2010, 2012) ~ "2010-2012",
    between(Year, 2020, 2022) ~ "2020-2022"
  ))

# Group by age_group and Year_Group, calculate the average LAO, and arrange the result
result <- laos %>%
