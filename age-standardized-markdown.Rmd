...
# Summary of life ladder + raw Ddata for predictors
...
```{r}
# Filter missing values for regression
...
Creating Dystopia
```{r}
# Dystopia collects the worst values for each 6 predictors, which becomes the baseline. We first create an empty row with the country name "Dystopia"
...
# We bind this row to the WHR_summary data frame, setting the values to be the minimum value (maximum for corruption) of all of the countries
...
```{r}
# Standard poopulation by WHO includes from age 0. Thus, reweighted to be only from Age 15 or above. Some rounding error means that these add up to 1.000474.
...
# Number of Countries in WHR: 137, AS: 143, so fixing to 137
...
#Impute missing data
standardized_WHR_summary_1[standardized_WHR_summary_1$Country.name=="State of Palestine", "Log.GDP.per.capita"] <- 
  (1.144)/(summary(Standardized_regression_1)$coefficients["Log.GDP.per.capita", "Estimate"]) + as.numeric(standardized_WHR_summary_1[
    standardized_WHR_summary_1$Country.name=="Dystopia", "Log.GDP.per.capita"])

standardized_WHR_summary_1[standardized_WHR_summary_1$Country.name=="Taiwan Province of China", "Log.GDP.per.capita"] <-
  (1.897)/(summary(Standardized_regression_1)$coefficients["Log.GDP.per.capita", "Estimate"]) + as.numeric(standardized_WHR_summary_1[
    standardized_WHR_summary_1$Country.name=="Dystopia", "Log.GDP.per.capita"])

standardized_WHR_summary_1[standardized_WHR_summary_1$Country.name=="Venezuela", "Log.GDP.per.capita"] <-
  (0)/(summary(Standardized_regression_1)$coefficients["Log.GDP.per.capita", "Estimate"]) + as.numeric(standardized_WHR_summary_1[
    standardized_WHR_summary_1$Country.name=="Dystopia", "Log.GDP.per.capita"])

standardized_WHR_summary_1[standardized_WHR_summary_1$Country.name=="Hong Kong S.A.R. of China", "Healthy.life.expectancy.at.birth"] <-
  (0.702)/(summary(Standardized_regression_1)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_1[
    standardized_WHR_summary_1$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_1[standardized_WHR_summary_1$Country.name=="Kosovo", "Healthy.life.expectancy.at.birth"] <-
  (0.372)/(summary(Standardized_regression_1)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_1[
    standardized_WHR_summary_1$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_1[standardized_WHR_summary_1$Country.name=="State of Palestine", "Healthy.life.expectancy.at.birth"] <-
  (0.292)/(summary(Standardized_regression_1)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_1[
    standardized_WHR_summary_1$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_1[standardized_WHR_summary_1$Country.name=="Taiwan Province of China", "Healthy.life.expectancy.at.birth"] <-
  (0.492)/(summary(Standardized_regression_1)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_1[
    standardized_WHR_summary_1$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_1[standardized_WHR_summary_1$Country.name=="Tajikistan", "Freedom.to.make.life.choices"] <-
  (0.599)/(summary(Standardized_regression_1)$coefficients["Freedom.to.make.life.choices", "Estimate"]) + as.numeric(standardized_WHR_summary_1[
    standardized_WHR_summary_1$Country.name=="Dystopia", "Freedom.to.make.life.choices"])

standardized_WHR_summary_1[standardized_WHR_summary_1$Country.name=="Venezuela", "Generosity"] <-
  (0.205)/(summary(Standardized_regression_1)$coefficients["Generosity", "Estimate"]) + as.numeric(standardized_WHR_summary_1[
    standardized_WHR_summary_1$Country.name=="Dystopia", "Generosity"])

standardized_WHR_summary_1[standardized_WHR_summary_1$Country.name=="State of Palestine", "Generosity"] <-
  (0.065)/(summary(Standardized_regression_1)$coefficients["Generosity", "Estimate"]) + as.numeric(standardized_WHR_summary_1[
    standardized_WHR_summary_1$Country.name=="Dystopia", "Generosity"])

standardized_WHR_summary_1[standardized_WHR_summary_1$Country.name=="Taiwan Province of China", "Generosity"] <-
  (0.067)/(summary(Standardized_regression_1)$coefficients["Generosity", "Estimate"]) + as.numeric(standardized_WHR_summary_1[
    standardized_WHR_summary_1$Country.name=="Dystopia", "Generosity"])

standardized_WHR_summary_1[standardized_WHR_summary_1$Country.name=="Saudi Arabia", "Perceptions.of.corruption"] <-
  (0.170)/(summary(Standardized_regression_1)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_1[
    standardized_WHR_summary_1$Country.name=="Dystopia", "Perceptions.of.corruption"])

standardized_WHR_summary_1[standardized_WHR_summary_1$Country.name=="Bahrain", "Perceptions.of.corruption"] <-
  (0.138)/(summary(Standardized_regression_1)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_1[
    standardized_WHR_summary_1$Country.name=="Dystopia", "Perceptions.of.corruption"])

standardized_WHR_summary_1[standardized_WHR_summary_1$Country.name=="China", "Perceptions.of.corruption"] <-
  (0.145)/(summary(Standardized_regression_1)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_1[
    standardized_WHR_summary_1$Country.name=="Dystopia", "Perceptions.of.corruption"])

standardized_WHR_summary_1[standardized_WHR_summary_1$Country.name=="United Arab Emirates", "Perceptions.of.corruption"] <-
  (0.247)/(summary(Standardized_regression_1)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_1[
    standardized_WHR_summary_1$Country.name=="Dystopia", "Perceptions.of.corruption"])
...
#Impute missing data
standardized_WHR_summary_2[standardized_WHR_summary_2$Country.name=="State of Palestine", "Log.GDP.per.capita"] <- 
  (1.144)/(summary(Standardized_regression_2)$coefficients["Log.GDP.per.capita", "Estimate"]) + as.numeric(standardized_WHR_summary_2[
    standardized_WHR_summary_2$Country.name=="Dystopia", "Log.GDP.per.capita"])

standardized_WHR_summary_2[standardized_WHR_summary_2$Country.name=="Taiwan Province of China", "Log.GDP.per.capita"] <-
  (1.897)/(summary(Standardized_regression_2)$coefficients["Log.GDP.per.capita", "Estimate"]) + as.numeric(standardized_WHR_summary_2[
    standardized_WHR_summary_2$Country.name=="Dystopia", "Log.GDP.per.capita"])

standardized_WHR_summary_2[standardized_WHR_summary_2$Country.name=="Venezuela", "Log.GDP.per.capita"] <-
  (0)/(summary(Standardized_regression_2)$coefficients["Log.GDP.per.capita", "Estimate"]) + as.numeric(standardized_WHR_summary_2[
    standardized_WHR_summary_2$Country.name=="Dystopia", "Log.GDP.per.capita"])

standardized_WHR_summary_2[standardized_WHR_summary_2$Country.name=="Hong Kong S.A.R. of China", "Healthy.life.expectancy.at.birth"] <-
  (0.702)/(summary(Standardized_regression_2)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_2[
    standardized_WHR_summary_2$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_2[standardized_WHR_summary_2$Country.name=="Kosovo", "Healthy.life.expectancy.at.birth"] <-
  (0.372)/(summary(Standardized_regression_2)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_2[
    standardized_WHR_summary_2$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_2[standardized_WHR_summary_2$Country.name=="State of Palestine", "Healthy.life.expectancy.at.birth"] <-
  (0.292)/(summary(Standardized_regression_2)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_2[
    standardized_WHR_summary_2$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_2[standardized_WHR_summary_2$Country.name=="Taiwan Province of China", "Healthy.life.expectancy.at.birth"] <-
  (0.492)/(summary(Standardized_regression_2)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_2[
    standardized_WHR_summary_2$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_2[standardized_WHR_summary_2$Country.name=="Tajikistan", "Freedom.to.make.life.choices"] <-
  (0.599)/(summary(Standardized_regression_2)$coefficients["Freedom.to.make.life.choices", "Estimate"]) + as.numeric(standardized_WHR_summary_2[
    standardized_WHR_summary_2$Country.name=="Dystopia", "Freedom.to.make.life.choices"])

standardized_WHR_summary_2[standardized_WHR_summary_2$Country.name=="Venezuela", "Generosity"] <-
  (0.205)/(summary(Standardized_regression_2)$coefficients["Generosity", "Estimate"]) + as.numeric(standardized_WHR_summary_2[
    standardized_WHR_summary_2$Country.name=="Dystopia", "Generosity"])

standardized_WHR_summary_2[standardized_WHR_summary_2$Country.name=="State of Palestine", "Generosity"] <-
  (0.065)/(summary(Standardized_regression_2)$coefficients["Generosity", "Estimate"]) + as.numeric(standardized_WHR_summary_2[
    standardized_WHR_summary_2$Country.name=="Dystopia", "Generosity"])

standardized_WHR_summary_2[standardized_WHR_summary_2$Country.name=="Taiwan Province of China", "Generosity"] <-
  (0.067)/(summary(Standardized_regression_2)$coefficients["Generosity", "Estimate"]) + as.numeric(standardized_WHR_summary_2[
    standardized_WHR_summary_2$Country.name=="Dystopia", "Generosity"])

standardized_WHR_summary_2[standardized_WHR_summary_2$Country.name=="Saudi Arabia", "Perceptions.of.corruption"] <-
  (0.170)/(summary(Standardized_regression_2)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_2[
    standardized_WHR_summary_2$Country.name=="Dystopia", "Perceptions.of.corruption"])

standardized_WHR_summary_2[standardized_WHR_summary_2$Country.name=="Bahrain", "Perceptions.of.corruption"] <-
  (0.138)/(summary(Standardized_regression_2)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_2[
    standardized_WHR_summary_2$Country.name=="Dystopia", "Perceptions.of.corruption"])

standardized_WHR_summary_2[standardized_WHR_summary_2$Country.name=="China", "Perceptions.of.corruption"] <-
  (0.145)/(summary(Standardized_regression_2)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_2[
    standardized_WHR_summary_2$Country.name=="Dystopia", "Perceptions.of.corruption"])

standardized_WHR_summary_2[standardized_WHR_summary_2$Country.name=="United Arab Emirates", "Perceptions.of.corruption"] <-
  (0.247)/(summary(Standardized_regression_2)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_2[
    standardized_WHR_summary_2$Country.name=="Dystopia", "Perceptions.of.corruption"])
...
#Impute missing data
standardized_WHR_summary_3[standardized_WHR_summary_3$Country.name=="State of Palestine", "Log.GDP.per.capita"] <- 
  (1.144)/(summary(Standardized_regression_3)$coefficients["Log.GDP.per.capita", "Estimate"]) + as.numeric(standardized_WHR_summary_3[
    standardized_WHR_summary_3$Country.name=="Dystopia", "Log.GDP.per.capita"])

standardized_WHR_summary_3[standardized_WHR_summary_3$Country.name=="Taiwan Province of China", "Log.GDP.per.capita"] <-
  (1.897)/(summary(Standardized_regression_3)$coefficients["Log.GDP.per.capita", "Estimate"]) + as.numeric(standardized_WHR_summary_3[
    standardized_WHR_summary_3$Country.name=="Dystopia", "Log.GDP.per.capita"])

standardized_WHR_summary_3[standardized_WHR_summary_3$Country.name=="Venezuela", "Log.GDP.per.capita"] <-
  (0)/(summary(Standardized_regression_3)$coefficients["Log.GDP.per.capita", "Estimate"]) + as.numeric(standardized_WHR_summary_3[
    standardized_WHR_summary_3$Country.name=="Dystopia", "Log.GDP.per.capita"])

standardized_WHR_summary_3[standardized_WHR_summary_3$Country.name=="Hong Kong S.A.R. of China", "Healthy.life.expectancy.at.birth"] <-
  (0.702)/(summary(Standardized_regression_3)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_3[
    standardized_WHR_summary_3$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_3[standardized_WHR_summary_3$Country.name=="Kosovo", "Healthy.life.expectancy.at.birth"] <-
  (0.372)/(summary(Standardized_regression_3)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_3[
    standardized_WHR_summary_3$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_3[standardized_WHR_summary_3$Country.name=="State of Palestine", "Healthy.life.expectancy.at.birth"] <-
  (0.292)/(summary(Standardized_regression_3)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_3[
    standardized_WHR_summary_3$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_3[standardized_WHR_summary_3$Country.name=="Taiwan Province of China", "Healthy.life.expectancy.at.birth"] <-
  (0.492)/(summary(Standardized_regression_3)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_3[
    standardized_WHR_summary_3$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_3[standardized_WHR_summary_3$Country.name=="Tajikistan", "Freedom.to.make.life.choices"] <-
  (0.599)/(summary(Standardized_regression_3)$coefficients["Freedom.to.make.life.choices", "Estimate"]) + as.numeric(standardized_WHR_summary_3[
    standardized_WHR_summary_3$Country.name=="Dystopia", "Freedom.to.make.life.choices"])

standardized_WHR_summary_3[standardized_WHR_summary_3$Country.name=="Venezuela", "Generosity"] <-
  (0.205)/(summary(Standardized_regression_3)$coefficients["Generosity", "Estimate"]) + as.numeric(standardized_WHR_summary_3[
    standardized_WHR_summary_3$Country.name=="Dystopia", "Generosity"])

standardized_WHR_summary_3[standardized_WHR_summary_3$Country.name=="State of Palestine", "Generosity"] <-
  (0.065)/(summary(Standardized_regression_3)$coefficients["Generosity", "Estimate"]) + as.numeric(standardized_WHR_summary_3[
    standardized_WHR_summary_3$Country.name=="Dystopia", "Generosity"])

standardized_WHR_summary_3[standardized_WHR_summary_3$Country.name=="Taiwan Province of China", "Generosity"] <-
  (0.067)/(summary(Standardized_regression_3)$coefficients["Generosity", "Estimate"]) + as.numeric(standardized_WHR_summary_3[
    standardized_WHR_summary_3$Country.name=="Dystopia", "Generosity"])

standardized_WHR_summary_3[standardized_WHR_summary_3$Country.name=="Saudi Arabia", "Perceptions.of.corruption"] <-
  (0.170)/(summary(Standardized_regression_3)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_3[
    standardized_WHR_summary_3$Country.name=="Dystopia", "Perceptions.of.corruption"])

standardized_WHR_summary_3[standardized_WHR_summary_3$Country.name=="Bahrain", "Perceptions.of.corruption"] <-
  (0.138)/(summary(Standardized_regression_3)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_3[
    standardized_WHR_summary_3$Country.name=="Dystopia", "Perceptions.of.corruption"])

standardized_WHR_summary_3[standardized_WHR_summary_3$Country.name=="China", "Perceptions.of.corruption"] <-
  (0.145)/(summary(Standardized_regression_3)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_3[
    standardized_WHR_summary_3$Country.name=="Dystopia", "Perceptions.of.corruption"])

standardized_WHR_summary_3[standardized_WHR_summary_3$Country.name=="United Arab Emirates", "Perceptions.of.corruption"] <-
  (0.247)/(summary(Standardized_regression_3)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_3[
    standardized_WHR_summary_3$Country.name=="Dystopia", "Perceptions.of.corruption"])
...
#Impute missing data
standardized_WHR_summary_4[standardized_WHR_summary_4$Country.name=="State of Palestine", "Log.GDP.per.capita"] <- 
  (1.144)/(summary(Standardized_regression_4)$coefficients["Log.GDP.per.capita", "Estimate"]) + as.numeric(standardized_WHR_summary_4[
    standardized_WHR_summary_4$Country.name=="Dystopia", "Log.GDP.per.capita"])

standardized_WHR_summary_4[standardized_WHR_summary_4$Country.name=="Taiwan Province of China", "Log.GDP.per.capita"] <-
  (1.897)/(summary(Standardized_regression_4)$coefficients["Log.GDP.per.capita", "Estimate"]) + as.numeric(standardized_WHR_summary_4[
    standardized_WHR_summary_4$Country.name=="Dystopia", "Log.GDP.per.capita"])

standardized_WHR_summary_4[standardized_WHR_summary_4$Country.name=="Venezuela", "Log.GDP.per.capita"] <-
  (0)/(summary(Standardized_regression_4)$coefficients["Log.GDP.per.capita", "Estimate"]) + as.numeric(standardized_WHR_summary_4[
    standardized_WHR_summary_4$Country.name=="Dystopia", "Log.GDP.per.capita"])

standardized_WHR_summary_4[standardized_WHR_summary_4$Country.name=="Hong Kong S.A.R. of China", "Healthy.life.expectancy.at.birth"] <-
  (0.702)/(summary(Standardized_regression_4)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_4[
    standardized_WHR_summary_4$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_4[standardized_WHR_summary_4$Country.name=="Kosovo", "Healthy.life.expectancy.at.birth"] <-
  (0.372)/(summary(Standardized_regression_4)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_4[
    standardized_WHR_summary_4$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_4[standardized_WHR_summary_4$Country.name=="State of Palestine", "Healthy.life.expectancy.at.birth"] <-
  (0.292)/(summary(Standardized_regression_4)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_4[
    standardized_WHR_summary_4$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_4[standardized_WHR_summary_4$Country.name=="Taiwan Province of China", "Healthy.life.expectancy.at.birth"] <-
  (0.492)/(summary(Standardized_regression_4)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_4[
    standardized_WHR_summary_4$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_4[standardized_WHR_summary_4$Country.name=="Tajikistan", "Freedom.to.make.life.choices"] <-
  (0.599)/(summary(Standardized_regression_4)$coefficients["Freedom.to.make.life.choices", "Estimate"]) + as.numeric(standardized_WHR_summary_4[
    standardized_WHR_summary_4$Country.name=="Dystopia", "Freedom.to.make.life.choices"])

standardized_WHR_summary_4[standardized_WHR_summary_4$Country.name=="Venezuela", "Generosity"] <-
  (0.205)/(summary(Standardized_regression_4)$coefficients["Generosity", "Estimate"]) + as.numeric(standardized_WHR_summary_4[
    standardized_WHR_summary_4$Country.name=="Dystopia", "Generosity"])

standardized_WHR_summary_4[standardized_WHR_summary_4$Country.name=="State of Palestine", "Generosity"] <-
  (0.065)/(summary(Standardized_regression_4)$coefficients["Generosity", "Estimate"]) + as.numeric(standardized_WHR_summary_4[
    standardized_WHR_summary_4$Country.name=="Dystopia", "Generosity"])

standardized_WHR_summary_4[standardized_WHR_summary_4$Country.name=="Taiwan Province of China", "Generosity"] <-
  (0.067)/(summary(Standardized_regression_4)$coefficients["Generosity", "Estimate"]) + as.numeric(standardized_WHR_summary_4[
    standardized_WHR_summary_4$Country.name=="Dystopia", "Generosity"])

standardized_WHR_summary_4[standardized_WHR_summary_4$Country.name=="Saudi Arabia", "Perceptions.of.corruption"] <-
  (0.170)/(summary(Standardized_regression_4)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_4[
    standardized_WHR_summary_4$Country.name=="Dystopia", "Perceptions.of.corruption"])

standardized_WHR_summary_4[standardized_WHR_summary_4$Country.name=="Bahrain", "Perceptions.of.corruption"] <-
  (0.138)/(summary(Standardized_regression_4)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_4[
    standardized_WHR_summary_4$Country.name=="Dystopia", "Perceptions.of.corruption"])

standardized_WHR_summary_4[standardized_WHR_summary_4$Country.name=="China", "Perceptions.of.corruption"] <-
  (0.145)/(summary(Standardized_regression_4)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_4[
    standardized_WHR_summary_4$Country.name=="Dystopia", "Perceptions.of.corruption"])

standardized_WHR_summary_4[standardized_WHR_summary_4$Country.name=="United Arab Emirates", "Perceptions.of.corruption"] <-
  (0.247)/(summary(Standardized_regression_4)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_4[
    standardized_WHR_summary_4$Country.name=="Dystopia", "Perceptions.of.corruption"])
...
#Impute missing data
standardized_WHR_summary_5[standardized_WHR_summary_5$Country.name=="State of Palestine", "Log.GDP.per.capita"] <- 
  (1.144)/(summary(Standardized_regression_5)$coefficients["Log.GDP.per.capita", "Estimate"]) + as.numeric(standardized_WHR_summary_5[
    standardized_WHR_summary_5$Country.name=="Dystopia", "Log.GDP.per.capita"])

standardized_WHR_summary_5[standardized_WHR_summary_5$Country.name=="Taiwan Province of China", "Log.GDP.per.capita"] <-
  (1.897)/(summary(Standardized_regression_5)$coefficients["Log.GDP.per.capita", "Estimate"]) + as.numeric(standardized_WHR_summary_5[
    standardized_WHR_summary_5$Country.name=="Dystopia", "Log.GDP.per.capita"])

standardized_WHR_summary_5[standardized_WHR_summary_5$Country.name=="Venezuela", "Log.GDP.per.capita"] <-
  (0)/(summary(Standardized_regression_5)$coefficients["Log.GDP.per.capita", "Estimate"]) + as.numeric(standardized_WHR_summary_5[
    standardized_WHR_summary_5$Country.name=="Dystopia", "Log.GDP.per.capita"])

standardized_WHR_summary_5[standardized_WHR_summary_5$Country.name=="Hong Kong S.A.R. of China", "Healthy.life.expectancy.at.birth"] <-
  (0.702)/(summary(Standardized_regression_5)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_5[
    standardized_WHR_summary_5$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_5[standardized_WHR_summary_5$Country.name=="Kosovo", "Healthy.life.expectancy.at.birth"] <-
  (0.372)/(summary(Standardized_regression_5)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_5[
    standardized_WHR_summary_5$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_5[standardized_WHR_summary_5$Country.name=="State of Palestine", "Healthy.life.expectancy.at.birth"] <-
  (0.292)/(summary(Standardized_regression_5)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_5[
    standardized_WHR_summary_5$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_5[standardized_WHR_summary_5$Country.name=="Taiwan Province of China", "Healthy.life.expectancy.at.birth"] <-
  (0.492)/(summary(Standardized_regression_5)$coefficients["Healthy.life.expectancy.at.birth", "Estimate"]) + as.numeric(standardized_WHR_summary_5[
    standardized_WHR_summary_5$Country.name=="Dystopia", "Healthy.life.expectancy.at.birth"])

standardized_WHR_summary_5[standardized_WHR_summary_5$Country.name=="Tajikistan", "Freedom.to.make.life.choices"] <-
  (0.599)/(summary(Standardized_regression_5)$coefficients["Freedom.to.make.life.choices", "Estimate"]) + as.numeric(standardized_WHR_summary_5[
    standardized_WHR_summary_5$Country.name=="Dystopia", "Freedom.to.make.life.choices"])

standardized_WHR_summary_5[standardized_WHR_summary_5$Country.name=="Venezuela", "Generosity"] <-
  (0.205)/(summary(Standardized_regression_5)$coefficients["Generosity", "Estimate"]) + as.numeric(standardized_WHR_summary_5[
    standardized_WHR_summary_5$Country.name=="Dystopia", "Generosity"])

standardized_WHR_summary_5[standardized_WHR_summary_5$Country.name=="State of Palestine", "Generosity"] <-
  (0.065)/(summary(Standardized_regression_5)$coefficients["Generosity", "Estimate"]) + as.numeric(standardized_WHR_summary_5[
    standardized_WHR_summary_5$Country.name=="Dystopia", "Generosity"])

standardized_WHR_summary_5[standardized_WHR_summary_5$Country.name=="Taiwan Province of China", "Generosity"] <-
  (0.067)/(summary(Standardized_regression_5)$coefficients["Generosity", "Estimate"]) + as.numeric(standardized_WHR_summary_5[
    standardized_WHR_summary_5$Country.name=="Dystopia", "Generosity"])

standardized_WHR_summary_5[standardized_WHR_summary_5$Country.name=="Saudi Arabia", "Perceptions.of.corruption"] <-
  (0.170)/(summary(Standardized_regression_5)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_5[
    standardized_WHR_summary_5$Country.name=="Dystopia", "Perceptions.of.corruption"])

standardized_WHR_summary_5[standardized_WHR_summary_5$Country.name=="Bahrain", "Perceptions.of.corruption"] <-
  (0.138)/(summary(Standardized_regression_5)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_5[
    standardized_WHR_summary_5$Country.name=="Dystopia", "Perceptions.of.corruption"])

standardized_WHR_summary_5[standardized_WHR_summary_5$Country.name=="China", "Perceptions.of.corruption"] <-
  (0.145)/(summary(Standardized_regression_5)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_5[
    standardized_WHR_summary_5$Country.name=="Dystopia", "Perceptions.of.corruption"])

standardized_WHR_summary_5[standardized_WHR_summary_5$Country.name=="United Arab Emirates", "Perceptions.of.corruption"] <-
  (0.247)/(summary(Standardized_regression_5)$coefficients["Perceptions.of.corruption", "Estimate"]) + as.numeric(standardized_WHR_summary_5[
    standardized_WHR_summary_5$Country.name=="Dystopia", "Perceptions.of.corruption"])
...
distance_from_dystopia_5 <- cbind((WHR_summary %>% 
                                               ...
                                               (standardized_WHR_summary_5[1:136, 3:8] - standardized_WHR_summary_5[rep(137, 136), 3:8]))
...
gallup_age_2010 <- gallup_main %>% 
  ...
  group_by(COUNTRYNEW, age_group, .drop = FALSE) %>% 
  summarise(WeightedMeanLS = (sum(Weighted.LS, na.rm=T)/sum(WGT, na.rm=T))) %>%
  pivot_wider(names_from = COUNTRYNEW, values_from = WeightedMeanLS)
...
age_standardized_ranking_2010$COUNTRYNEW <- gsub(
  '_ASLS', '', age_standardized_ranking_2010$COUNTRYNEW)
n_2010 <- gallup_main %>% 
  drop_na(Weighted.LS) %>% 
  filter(YEAR_CALENDAR == 2010) %>% 
  group_by(COUNTRYNEW) %>% 
...
age_standardized_ranking_2011$COUNTRYNEW <- gsub(
  '_ASLS', '', age_standardized_ranking_2011$COUNTRYNEW)
n_2011 <- gallup_main %>% 
  drop_na(Weighted.LS) %>% 
  filter(YEAR_CALENDAR == 2011) %>% 
  group_by(COUNTRYNEW) %>% 
...
age_standardized_ranking_2012$COUNTRYNEW <- gsub(
  '_ASLS', '', age_standardized_ranking_2012$COUNTRYNEW)
n_2012 <- gallup_main %>% 
  drop_na(Weighted.LS) %>% 
  filter(YEAR_CALENDAR == 2012) %>% 
  group_by(COUNTRYNEW) %>% 
...
age_ranking_2010_2011 <- merge(x = age_standardized_ranking_2010, y = age_standardized_ranking_2011, by = "COUNTRYNEW", all = TRUE)
age_standardized_ranking_2013 <- merge(x = age_ranking_2010_2011, y = age_standardized_ranking_2012, by = "COUNTRYNEW", all = TRUE)
...
age_standardized_ranking_2013 <- age_standardized_ranking_2013 %>% 
  dplyr::select(Country = COUNTRYNEW, AS_score)
...
comparison_2013_2023 <- merge(WHR_AS_comparison, WHR_AS_comparison_2013, by.x="region", by.y="Country")
notable_countries <- comparison_2013_2023 %>% 
  ...
  dplyr::select(COUNTRY_ISO3 = COUNTRY_ISO3.x, Country = region, WHR_2023 = WHR_score, AS_2023 = AS_score.x, WHR_2013 = Ladder, AS_2013 = AS_score.y)
...
significant_changes_in_rank_1 <- standardized_contributions_1 %>% 
  filter(abs(rank_difference) >= 10) %>% 
  dplyr::select(COUNTRY_ISO3, standardized_contributions_1, WHR_score, AS.LS, rank_difference, score_difference)
```
...
significant_changes_in_rank_2 <- standardized_contributions_2 %>% 
  filter(abs(rank_difference) >= 10) %>% 
  dplyr::select(COUNTRY_ISO3, standardized_contributions_2, WHR_score, AS.LS, rank_difference, score_difference)
```
...
significant_changes_in_rank_3 <- standardized_contributions_3 %>% 
  filter(abs(rank_difference) >= 10) %>% 
  dplyr::select(COUNTRY_ISO3, standardized_contributions_3, WHR_score, AS.LS, rank_difference, score_difference)
```
...
significant_changes_in_rank_4 <- standardized_contributions_4 %>% 
  filter(abs(rank_difference) >= 10) %>% 
  dplyr::select(COUNTRY_ISO3, standardized_contributions_4, WHR_score, AS.LS, rank_difference, score_difference)
```
...
significant_changes_in_rank_5 <- standardized_contributions_5 %>% 
  filter(abs(rank_difference) >= 10) %>% 
  dplyr::select(COUNTRY_ISO3, standardized_contributions_5, WHR_score, AS.LS, rank_difference, score_difference)
...
age_specific_ranking_comparisons <- standardized_contributions_1 %>% 
  dplyr::select(COUNTRY_ISO3, AG1_score = AS.LS, AG1_rank = Rank) %>%
  left_join(
    standardized_contributions_2 %>% dplyr::select(COUNTRY_ISO3, AG2_score = AS.LS, AG2_rank = Rank),
    by = "COUNTRY_ISO3"
  ) %>%
  left_join(
    standardized_contributions_3 %>% dplyr::select(COUNTRY_ISO3, AG3_score = AS.LS, AG3_rank = Rank),
    by = "COUNTRY_ISO3"
  ) %>%
  left_join(
    standardized_contributions_4 %>% dplyr::select(COUNTRY_ISO3, AG4_score = AS.LS, AG4_rank = Rank),
    by = "COUNTRY_ISO3"
  ) %>%
  left_join(
    standardized_contributions_5 %>% dplyr::select(COUNTRY_ISO3, AG5_score = AS.LS, AG5_rank = Rank),
    by = "COUNTRY_ISO3"
  ) 
...
```{r}
a <- ranking_comparisons %>% 
  dplyr::select(COUNTRY_ISO3, COUNTRYNAME = region, WHR_rank, AS_rank, AG1_rank, AG4_rank)

color_scale <- scales::col_numeric(palette = "viridis", domain = range(a$WHR_rank))

long_data <- tidyr::gather(a, key = "Ranking", value = "Value", -COUNTRY_ISO3, -COUNTRYNAME)
long_data$COUNTRY_ISO3 <- reorder(long_data$COUNTRY_ISO3, long_data$Value)

# Plot the heatmap
ggplot(long_data, aes(x = COUNTRY_ISO3, y = Ranking, fill = Value)) +
  geom_tile() +
  scale_fill_viridis() +  # Use the same color scale for all ranks
  theme_minimal() +
  labs(title = "Comparison of Ranks",
       x = "Country",
       y = "Ranking",
       fill = "WHR_rank")
```
