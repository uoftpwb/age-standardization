...
standardized_contributions_1 <- merge(standardized_contributions_1, gallup_main %>% 
  filter(age_group == "15-29",
         YEAR_CALENDAR >= 2020, YEAR_CALENDAR <= 2022) %>% 
  drop_na(Weighted.LS) %>% 
  group_by(COUNTRY_ISO3) %>%
  summarize(n = n()), by="COUNTRY_ISO3")
```
...
standardized_contributions_2 <- merge(standardized_contributions_2, gallup_main %>% 
  filter(age_group == "30-44",
         YEAR_CALENDAR >= 2020, YEAR_CALENDAR <= 2022) %>% 
  drop_na(Weighted.LS) %>% 
  group_by(COUNTRY_ISO3) %>%
...
standardized_contributions_3 <- merge(standardized_contributions_3, gallup_main %>% 
  filter(age_group == "45-59",
         YEAR_CALENDAR >= 2020, YEAR_CALENDAR <= 2022) %>% 
  drop_na(Weighted.LS) %>% 
  group_by(COUNTRY_ISO3) %>%
...
standardized_contributions_4 <- merge(standardized_contributions_4, gallup_main %>% 
  filter(age_group == "60-74",
         YEAR_CALENDAR >= 2020, YEAR_CALENDAR <= 2022) %>% 
  drop_na(Weighted.LS) %>% 
  group_by(COUNTRY_ISO3) %>%
...
# TEMPORARY: Impute Saudi Arabia with value from age group 4
age_standardized_ranking_5 <- rbind(age_standardized_ranking_5, c("SAU", 6.522103, "Saudi Arabia"))
...
standardized_contributions_5 <- merge(standardized_contributions_5, gallup_main %>% 
  filter(age_group == "Over 75",
         YEAR_CALENDAR >= 2020, YEAR_CALENDAR <= 2022) %>% 
  drop_na(Weighted.LS) %>% 
  group_by(COUNTRY_ISO3) %>%
