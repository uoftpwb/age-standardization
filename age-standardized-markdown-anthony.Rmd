...
ggplot(df_long, aes(x = variable, y = WHR2, fill = factor(value))) +
  ...
  labs(title = "Ranking Comparison", x = "Ranking Type", y = "Ranking") +
  theme_minimal() +
  scale_y_reverse() +
...
ggsave(file="ranking_color_comparison.pdf", width=3, height=8, dpi=300)
```
