...
# "Data/WHR2023Table.csv" is data obtained directly from the World Happiness Report Appendices & Data [TODO: Name of the file, and exactly where to find it.] [Split the n column into its own file]. n is a column added manually from the Statistical Appendix 1 for Chapter 2.
...
# TODO: Add explanation of methodology for imputation. Explain exactly where the data is missing.
# Impute values for Palestine because data is missing from WHR Data, using backward engineering.
# "0.292" comes from Palestine's "Explained by Healthy life expectancy" value in Figure 2.1 from WHR Chapter 2.
...
# TODO: YEAR_WAVE used instead of YEAR_CALENDAR
