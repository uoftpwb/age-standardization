...
ranking_comparisons_table <- ranking_comparisons_summary %>%
  mutate("WHR" = paste(WHR_rank, " (", sprintf("%.3f", round(WHR_score, 3)), ")", sep = ""),
         "Age-Standardized" = paste(AS_rank, " (", sprintf("%.3f", round(AS_score, 3)), ")", sep = ""),
         "Age Group 1 (15-29)" = paste(AG1_rank, " (", sprintf("%.3f", round(AG1_score, 3)), ")", sep = ""),
         "Age Group 2 (30-44)" = paste(AG2_rank, " (", sprintf("%.3f", round(AG2_score, 3)), ")", sep = ""),
         "Age Group 3 (45-59)" = paste(AG3_rank, " (", sprintf("%.3f", round(AG3_score, 3)), ")", sep = ""),
         "Age Group 4 (60-74)" = paste(AG4_rank, " (", sprintf("%.3f", round(AG4_score, 3)), ")", sep = ""),
         "Age Group 5 (Over 74)" = paste(AG5_rank, " (", sprintf("%.3f", round(AG5_score, 3)), ")", sep = "")) %>% 
