...
saveRDS(gallupSubset, "(231101)GWP_RawSubset_ageStandardizedWellbeing.rds")
```
...
# Read the RDS file
gallupSubset <- readRDS("(231101)GWP_RawSubset_ageStandardizedWellbeing.rds")
```
...
saveRDS(gallup, "(231101)GWP_cleaned_ageStandardizedWellbeing.rds")
```
