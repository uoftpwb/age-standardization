...
gallupSubset <- gallupRaw %>% 
    ...
    filter(YEAR_WAVE >= 2019)

# Save the gallupSubset data frame to a .rds file for later use
saveRDS(gallupSubset, "(231027)GWP_RawSubset_ageStandardizedWellbeing.rds")
```
...
Loaded via a namespace (and not attached): zip_2.2.0, Rcpp_1.0.6, cellranger_1.1.0, pillar_1.6.1, compiler_4.0.3, forcats_0.5.1, base64enc_0.1-3, tools_4.0.3, bit_4.0.4, digest_0.6.27, uuid_0.1-4, jsonlite_1.7.2, evaluate_0.14, lifecycle_1.0.0, tibble_3.1.2, pkgconfig_2.0.3, rlang_0.4.11, openxlsx_4.2.3, IRdisplay_1.0, IRkernel_1.2, curl_4.3.1, haven_2.4.1, rio_0.5.26, repr_1.1.3, generics_0.1.0, vctrs_0.3.8, hms_1.1.0, bit64_4.0.5, tidyselect_1.1.1, data.table_1.14.0, R6_2.5.0, fansi_0.5.0, readxl_1.3.1, foreign_0.8-80, pbdZMQ_0.3-5, purrr_0.3.4, magrittr_2.0.1, ellipsis_0.3.2, htmltools_0.5.1.1, utf8_1.2.1, stringi_1.6.2, crayon_1.4.1
...
# Read the RDS file
gallupSubset <- readRDS("(231027)GWP_RawSubset_ageStandardizedWellbeing.rds")
```
...
saveRDS(gallup, "(231027)GWP_cleaned_ageStandardizedWellbeing.rds")
```
